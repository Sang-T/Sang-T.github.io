...
const TRANSLATIONS = {
  ...
  ko: {
    ...
    "education.d3Gpa": "전체 학점 4.08 / 4.5 · 전공 학점 4.2 / 4.5",
    "education.d3Desc": "융합창업학부 SW스타트업 복수전공",
  ...
  en: {
    ...
    "education.d3Gpa": "Overall GPA 4.08 / 4.5 · Major GPA 4.2 / 4.5",
    "education.d3Desc":
      "Double major in SW Startup, School of Convergence Entrepreneurship",
